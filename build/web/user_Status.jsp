...
<form action="" method="post" name="form1" id="form1" >
                        ...
                        <table width="98%" border="0" align="center">
                            <%       
                                ...
                                ResultSet rs0 = stmt3.executeQuery("select * from booktb where UserName='"+uname+"' and status='waiting'");
                                int s = 0;
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
                            ...
                            <tr>
                                ...
                                <td width="111"><h4 align="center" class="style7 style4"><strong>Status</strong></h4></td>
                               
                               
                                <td width="102"><h4 align="center" class="style7 style4">cancel Booking</h4></td>
                            ...
                            <tr>
                                ...
                                <td><div align="center"><span class="style1">
                                        ...
                                        <td><div align="center"><span class="style1">
                                            <% out.print(rs0.getString("status"));%>
                                        </span></div></td>
                                         
                                       <td><div align="center"><span class="style1">
                                                   <a href="cancel.jsp?fid=<% out.print(rs0.getString("id")); %>">Cancel</a>
                                        </span></div></td>
