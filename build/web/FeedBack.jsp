...
try
{
    ...
    if(btn.equals("Submit"))
    {
      ...
      String qry = "select max(id) as maxid from feedtb";
                    ...
                    String ins="insert into feedtb values('"+id2+"','"+name+"','"+mob+"','"+feed+"')";
...
-->
  ...
  <tr>
    ...
    <td colspan="2"><div align="center" class="style4">New FeedBack </div></td>
    <td width="148">&nbsp;</td>
  </tr>
  <tr>
    <td height="41">&nbsp;</td>
  ...
  <tr>
    <td height="40">&nbsp;</td>
    <td><div align="center" class="style5">Feedback : </div></td>
    <td><input name="feed" type="text"></td>
    <td>&nbsp;</td>
  </tr>
