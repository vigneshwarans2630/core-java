...
String sql="select * from booktb where id='"+id+"'";
ResultSet rs=stmt.executeQuery(sql);
if(rs.next())
{
    String name=rs.getString("Username");
    nam=name;
    String contact=rs.getString("Mechanicname");
    mname=contact;
    String email=rs.getString("Mobile");
    mob=email;
    String VehicleType=rs.getString("Reason");
    reason=VehicleType;
    String Amount=rs.getString("Date");
    date=Amount;
}
%>
...
try
{
    ...
    {
      String sql1="delete from booktb where id='"+id+"'  ";
      int n=stmt.executeUpdate(sql1);
      if(n==1)
      {
          %>
          <script language="javascript">
              alert("Payment Successfully Refund");
...
try
{
    String but=request.getParameter("Cancel");
    if(but.equals("Cancel"))
    {
...
<table width="997">
  <tr>
    <td width="338" height="40">&nbsp;</td>
    <td colspan="2"><div align="center" class="style3">Cancel Booking : </div></td>
    <td width="179">&nbsp;</td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
    <td width="247"><div align="center" class="style4">User Name : </div></td>
    <td width="213"><% out.print(nam); %></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
    <td><div align="center" class="style4">Mechanical Name : </div></td>
    <td><% out.print(mname); %></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="42">&nbsp;</td>
    <td><div align="center" class="style4">Mobile : </div></td>
    <td><% out.print(mob); %></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="43">&nbsp;</td>
    <td><div align="center" class="style4">Reason : </div></td>
  ...
  <tr>
    ...
    <td><input name="Cancel" type="submit" class="btn-success" value="Cancel"></td>
    <td>&nbsp;</td>
  </tr>
</table>
       </form>
