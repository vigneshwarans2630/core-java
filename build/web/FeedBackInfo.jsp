			...
			<h2><a href="index.jsp">E Mechanic</a></h2>
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav menu">
                            ...
                            <li><a href="admin_userdetails.jsp">User Info</a></li>
                            <li><a href="admin_mechdetails.jsp">Mechanic Info</a></li>
                            <li><a href="admin_viewbook.jsp">Booking Details</a></li>
                            <li><a href="FeedBackInfo.jsp">FeedBack Details</a></li>
...
<form action="" method="post" name="form1" id="form1" >
                        <p>&nbsp;</p>
                        <h3 align="center" class="style3" >FeedBack Details </h3>
                        <table width="98%" border="0" align="center">
                            <%       
                               
                                ResultSet rs0 = stmt3.executeQuery("select * from feedtb ");
                                int s = 0;
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
                            ...
                            <tr>
                                ...
                                <td width="98"><h4 align="center" class="style7 style4"><strong>userName</strong></h4></td>
                                <td width="99"><h4 align="center" class="style7 style4"><strong>Mobile</strong></h4></td>
                                
                                <td width="84"><h4 align="center" class="style7 style4"><strong>FeedBack</strong></h4></td>
                            ...
                            <tr>
                                ...
                                <td><div align="center"><span class="style1">
                                            <% out.print(rs0.getString("FeedBack"));%>
                                        </span></div></td>
