...
try
{
  ...
  if(btn.equals("Submit"))
  {
      ...
      String n="select * from mech where uname='"+name+"' && Password='"+pass+"'";
      ...
      else
      {
          ...
          <script language="javascript">
              alert("Login Failed");
              window.location.href="machanic.jsp";
          </script>
          <%
      }
  }
...
-->
    ...
    <body>
		...
		<div id="logo">
			<h2><a href="index.jsp">E Mechanic</a></h2>
				...
				<li><a href="machanic.jsp">Mechanic</a></li>
  ...
  <tr>
    ...
    <td colspan="2"><div align="center" class="style1">Mechanic Login : </div></td>
    <td width="225">&nbsp;</td>
  </tr>
  <tr>
    <td height="44">&nbsp;</td>
    <td width="217"><div align="center"><span class="style2">Licence Number : </span></div></td>
  ...
  <td height="49"></td>
  <td>&nbsp;</td>
  <td><div align="center"><a href="mech_reg.jsp" class="style3">New Mechanic</a></div></td>
  <td></td>
  </tr>
</table>
       </form>
