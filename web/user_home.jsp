...
<table width="999">
  <tr>
    ...
    <td colspan="2"><div align="center" class="style3">User Search : </div></td>
    <td width="183">&nbsp;</td>
  </tr>
  <tr>
    <td height="47">&nbsp;</td>
    <td width="205"><div align="center"><span class="style2">Vehicle Type  : </span></div></td>
...
if(n==1)
{
    String name=request.getParameter("name").toString().trim();
     ResultSet rs0 = stmt3.executeQuery("select * from mech where VehicleType like '%"+name+"%' ");
               int s = 0;
               while (rs0.next()) {
               if (s == 0) {
