...
<form action="" method="post" name="form1" id="form1" >
                        <p>&nbsp;</p>
                        <h3 align="center" class="style3" >Charging Station Details </h3>
                        <table width="98%" border="0" align="center">
                            <%       
                               
                                ResultSet rs0 = stmt3.executeQuery("select * from station ");
                                int s = 0;
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
                            ...
                            <tr>
                                ...
                                <td width="99"><h4 align="center" class="style7 style4"><strong>Two Wheeler Slaps</strong></h4></td>
                                
                                <td width="84"><h4 align="center" class="style7 style4"><strong>Four Wheeler Slaps</strong></h4></td>
                                <td width="62"><h4 align="center" class="style7 style4"><strong>Two Wheeler Cost</strong></h4></td>
                                <td width="61"><h4 align="center" class="style7 style4"><strong>Four Wheeler Cost</strong></h4></td>
                                <td width="111"><h4 align="center" class="style7 style4"><strong>Contact</strong></h4></td>
                                <td width="75"><h4 align="center" class="style7 style4"><strong>Email</strong></h4></td>
                                <td width="102"><h4 align="center" class="style7 style4">District</h4></td>
                                <td width="102"><h4 align="center" class="style7 style4">address</h4></td>
                                <td width="102"><h4 align="center" class="style7 style4">Booking</h4></td>
                            ...
                            <tr>
                                ...
                                <td><div align="center"><span class="style1">
                                            <% out.print(rs0.getString("two"));%>
                                        </span></div></td>
                                <td><div align="center"><span class="style1">
                                            <% out.print(rs0.getString("four"));%>
                                        </span></div></td>
                                <td><div align="center"><span class="style1">
                                            <% out.print(rs0.getString("tcost"));%>
                                        </span></div></td>
                                         <td><div align="center"><span class="style1">
                                            <% out.print(rs0.getString("fcost"));%>
                                        </span></div></td>
                                         <td><div align="center"><span class="style1">
                                        ...
                                        <td><div align="center"><span class="style1">
                                            <% out.print(rs0.getString("district"));%>
                                        </span></div></td>
                                         <td><div align="center"><span class="style1">
