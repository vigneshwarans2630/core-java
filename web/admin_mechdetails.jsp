...
-->
    ...
    <body>
      ...
      <form action="" method="post" name="form1" id="form1" >
                        <p>&nbsp;</p>
                        <h3 align="center" class="style3" >Mechanic Details </h3>
                        <table width="98%" border="0" align="center">
                            <%       
                               
                                ResultSet rs0 = stmt3.executeQuery("select * from mech ");
                                int s = 0;
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
                            ...
                            <td width="102"><h4 align="center" class="style7 style4">Vehicle Type</h4></td>
                            ...
                            <tr>
                                ...
                                <td><div align="center"><span class="style1">
                                        ...
                                        <td><div align="center"><span class="style1">
                                            <% out.print(rs0.getString("VehicleType"));%>
                                        </span></div></td>
